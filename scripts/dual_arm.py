...
if __name__ == '__main__':
    ...
    joint_goal = [1.60441 ,1.51589 ,-1.45361, -2.56111, 2.84069 ,3.23779, -0.408184, 0.142083, 0.0770971 ,0.126544 ,-1.61819 ,0.162839, 1.6443, 2.04722]
#     joint_goal = []
    ...
    mdp.scene.attach_mesh(mdp.group_right.get_end_effector_link(), "assembly", touch_links= touch_links)
